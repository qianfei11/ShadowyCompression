...
public class ForwardDCT {
	...
	public static BigInteger[] forwardDCT(BigInteger[] Imgs, PublicKey PK, BigInteger sk) {
		BigInteger[] res = new BigInteger[64];
//		BigInteger thresholdVal = new BigInteger("1125899906842624"); // 2**50
...
//				BigInteger dTemp = p.De(PK, sk, temp);
//				if (dTemp.compareTo(thresholdVal) == 1) {
//					dTemp = dTemp.subtract(PK.n);
//				}
//				res[ZigZag[v * 8 + u]] = dTemp.divide(new BigInteger("1000000000000"));
			}
		}
		return res;
	}
